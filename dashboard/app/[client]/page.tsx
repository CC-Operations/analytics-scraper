        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <div className="flex items-center gap-3">
              <span className="rec-dot" style={{ width: 10, height: 10, borderRadius: "50%", background: PINK, flexShrink: 0, display: "inline-block" }} />
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  if (data.status === "already_running") {
                    ...
                    setRefreshMsg(data.message ?? "Too soon — try again later");
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all border"
              style={{ borderColor: "rgba(255,255,255,0.12)", color: refreshState === "done" ? "#4ade80" : refreshState === "error" ? "#f87171" : refreshState === "cooldown" ? "#facc15" : "rgba(255,255,255,0.45)", background: "transparent", opacity: refreshState === "loading" ? 0.6 : 1 }}>
              {refreshState === "loading" ? "↻ Refreshing..." : refreshState === "done" ? "✓ Started" : refreshState === "error" ? "✕ Error" : refreshState === "cooldown" ? `⏳ ${refreshMsg}` : "↻ Refresh"}
            </button>
